    ...
    <body>
        ...
        <section class="description_content">
            ...
            <table align="center">
                <tr>
                    <td>
                        <form action="mesa2.php#pricing">
                            <div align="center">
                                <button type="submit" name="continuar" class="text-center form-boton form-btn2">Seguir agregando</button>
                            </div>
                        </form>
                    </td>
                    <td>
                        <form action="finalizar_message.php">
                            <div align="center">
                                <button type="submit" name="finalizar" class="text-center form-boton form-btn2">Finalizar pedido</button>
                            </div>
                        </form>
                    </td>
                </tr>
