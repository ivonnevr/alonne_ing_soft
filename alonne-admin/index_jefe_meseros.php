...
<html lang="en">
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            <li><a class="navactive color_animation" href="index_jefe_meseros.php">Meseros</a></li>
                            <li><a class="color_animation" href="jefemeseros_mesas.php">Mesas</a></li>
        ...
        <section id ="meseros" class="description_content">
            <br>
            <br>
            <br>
            <h1 class="titleForm">Meseros</h1>
            <br>
            <br>
            <br>
