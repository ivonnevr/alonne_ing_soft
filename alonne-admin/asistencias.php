...
<html lang="en">
    ...
    <body>
        ...
        <section id ="asistencias" class="description_content">
            ...
            <br>
            <br>
            <form action="asistencias_listar.php">
                <button type="submit" id="listar_asistencias" name="listar_asistencias" class="boton">Ver asistencias</button>
            </form>
            <br>
            <form action="asistencias_eliminar.php">
                <button type="submit" id="eliminar_asistencia" name="eliminar_asistencia" class="boton">Eliminar asistencia</button>
            </form>
            <br>
            <form action="truncate_asistencias.php">
