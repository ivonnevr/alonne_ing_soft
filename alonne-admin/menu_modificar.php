...
<html lang="en">
    ...
    <body>
        ...
        <section id ="menu" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Modificar menu</h1>
            <br>
            <br>
            <br>
            <form action="menu_modificar_nombre.php">
                <button type="submit" id="nombre" name="nombre" class="boton">Modificar nombre</button>
            </form>
            <br>
            <form action="menu_modificar_descripcion.php">
                <button type="submit" id="apellidos" name="apellidos" class="boton">Modificar descripción</button>
            </form>
            <br>
            <form action="menu_modificar_precio.php">
                <button type="submit" id="direccion" name="direccion" class="boton">Modificar precio</button>
            </form>
            <br>
            <form action="menu_modificar_tipo.php">
                <button type="submit" id="telefono" name="telefono" class="boton">Modificar tipo</button>
            </form>
