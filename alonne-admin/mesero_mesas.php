...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="navactive color_animation" href="mesero_mesas.php">Mesas asignadas</a></li>
        ...
        <section id ="mesas" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Mesas asignadas</h1>
            <br>
            <br>
            <br>
            ...
            <?php
                ...
                echo "<tr>
                        ...
                        <th>
                            <p class='margen'>ID mesero a cargo</p>
                        </th>
                        <th>
                            <p class='margen'>Nombre mesero a cargo</p>
                        </th>
                    </tr>";
                foreach($stmt->fetchAll() as $mesa) {
                    echo "<tr>
                            <td>" . $mesa['id'] . "</td>
                            <td>" . $mesa['id_mesero'] . "</td>
