...
<html lang="en">
    ...
    <body>
        ...
        <section id ="ordenes" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Asignar mesa</h1>
            <br>
            <br>
            <br>
            <br>
            <form action="store_mesa.php" method="POST">

                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID del mesero a cargo" />
                <input type="text" name="nombre" id="nombre" required="required" class="formulario" placeholder="Nombre del mesero a cargo" /><br>
