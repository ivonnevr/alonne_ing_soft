...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="navactive color_animation" href="admin_ordenes.php">Pedidos</a></li>
        ...
        <section id ="ordenes" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Eliminar pedido</h1>
            <br>
            <br>
            <br>
            <br>
            ...
            <br>
            <br>
            <form action="delete_orden.php" method="POST">

                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID del pedido a eliminar" />
                
                <div align="center">
                    <table>
                        <tr>
                            <td>
                            <button type="submit" id="delete" name="delete" class="text-center form-boton form-btn2">Eliminar</button>
                            </td>
                            <td>
