...
<html lang="en">
    ...
    <body>
        ...
        <section id ="empleados" class="description_content">
            ...
            <br>
            <br>
            <form action="empleados_agregar.php">
                <button type="submit" id="agregar_empleado" name="agregar_empleado" class="boton">Agregar empleado</button>
            </form>
            <br>
            <form action="empleados_listar.php">
                <button type="submit" id="listar_empleados" name="listar_empleados" class="boton">Listar empleados</button>
            </form>
            <br>
            <form action="empleados_modificar.php">
                <button type="submit" id="modificar_empleado" name="modificar_empleado" class="boton">Modificar empleado</button>
            </form>
            <br>
            <form action="empleados_eliminar.php">
                <button type="submit" id="eliminar_empleado" name="eliminar_empleado" class="boton">Eliminar empleado</button>
            </form>
            <br>
            <br>
        </section>
