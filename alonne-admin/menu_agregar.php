...
<html lang="en">
    ...
    <body>
        ...
        <section id ="menu" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Agregar platillo</h1>
            <br>
            <br>
            <br>
            <br>
            <form action="store_menu.php" method="POST">

                <input type="text" name="nombre_platillo" id="nombre_platillo" required="required" class="formulario" placeholder="Nombre del platillo" />
                <input type="text" name="descripcion" id="descripcion" required="required" class="formulario" placeholder="Descripción del platillo" /><br>
                <input type="text" name="precio" id="precio" required="required" class="formulario" placeholder="Precio del platillo" />
                <select name="tipo" id="tipo" class="formulario">
                    <option disabled selected>Seleccione el tipo de platillo</option>
                    <option value="Plato fuerte">Plato fuerte</option>
                    <option value="Bebida">Bebida</option>
                    <option value="Postre">Postre</option>
                </select>
				<div align="center">
					<input type="file" name="imagen" class="formulario">
				</div>
