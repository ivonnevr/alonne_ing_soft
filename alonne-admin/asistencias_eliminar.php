...
<html lang="en">
    ...
    <body>
        ...
        <section id ="asistencias" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Eliminar asistencia</h1>
            <br>
            <br>
            <br>
            <br>
            ...
            <br>
            <br>
            <form action="delete_asistencia.php" method="POST">

                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID de la asistencia a eliminar" />
