...
<html lang="en">
    ...
    <body>
        ...
        <section id ="ordenes" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Ver pedidos</h1>
            <br>
            <br>
            <br>
            ...
            <?php
                ...
                echo "<tr>
                        ...
                        <th>
                            <p class='margen'>Platillo pedido</p>
                        </th>
                        <th>
                            <p class='margen'>Descripción del platillo</p>
                        </th>
                        <th>
                            <p class='margen'>Precio del platillo</p>
                        </th>
                        <th>
                            <p class='margen'>Mesa</p>
                        </th>
                        <th>
                            <p class='margen'>Estatus del pedido</p>
                        </th>
                    </tr>";
