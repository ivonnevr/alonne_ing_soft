...
<html lang="en">
    ...
    <body>
        ...
        <section id ="menu" class="description_content">
            ...
            <br>
            <br>
            <form action="menu_agregar.php">
                <button type="submit" id="agregar_platillo" name="agregar_platillo" class="boton">Agregar platillo</button>
            </form>
            <br>
            <form action="menu_listar.php">
                <button type="submit" id="listar_menu" name="listar_menu" class="boton">Ver menú</button>
            </form>
            <br>
            <form action="menu_modificar.php">
                <button type="submit" id="modificar_menu" name="modificar_menu" class="boton">Modificar menú</button>
            </form>
            <br>
            <form action="menu_eliminar.php">
                <button type="submit" id="eliminar_menu" name="eliminar_menú" class="boton">Eliminar platillo</button>
            </form>
            <br>
            <br>
        </section>
