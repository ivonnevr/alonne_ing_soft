...
<html lang="en">
    ...
    <body>
        ...
        <section id ="menu" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Modificar descripción</h1>
            <br>
            <br>
            <br>
            <br>
            <br>
            <br>
            <form action="update_menu_descripcion.php" method="POST">

                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID del platillo a modificar" />
                <input type="text" name="descripcion" id="descripcion" required="required" class="formulario" placeholder="Nueva descripción" />
