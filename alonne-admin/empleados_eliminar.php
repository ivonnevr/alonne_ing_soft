...
<html lang="en">
    ...
    <body>
        ...
        <section id ="empleados" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Eliminar empleado</h1>
            <br>
            <br>
            <br>
            <br>
            ...
            <br>
            <br>
            <form action="delete_empleados.php" method="POST">

                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID del empleado a eliminar" />
