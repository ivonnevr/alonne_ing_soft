...
<html lang="en">
    ...
    <body>
                ...
                <div class="row">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav main-nav  clear navbar-right ">
                            ...
                            <li><a class="navactive color_animation" href="admin_mesas.php">Mesas</a></li>
        ...
        <section id ="mesas" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Reasignar mesa</h1>
            <br>
            <br>
            <br>
            <br>
            ...
            <form action="update_mesa.php" method="POST">
                ...
                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID de la mesa a reasignar" /><br>
                <input type="text" name="id_empleado" id="id_empleado" required="required" class="formulario" placeholder="ID del mesero a cargo" />
                <input type="text" name="nombre" id="nombre" required="required" class="formulario" placeholder="Nombre del mesero a cargo" />
