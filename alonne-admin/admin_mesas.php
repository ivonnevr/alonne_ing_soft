...
<html lang="en">
    ...
    <body>
        ...
        <section id ="mesas" class="description_content">
            ...
            <br>
            <br>
            <form action="mesas_asignar.php">
                <button type="submit" id="asignar_mesa" name="asignar_mesa" class="boton">Agregar mesa</button>
            </form>
            <br>
            <form action="mesas_listar.php">
                <button type="submit" id="listar_mesas" name="listar_mesas" class="boton">Ver mesas</button>
            </form>
            <br>
            <form action="mesas_reasignar.php">
