...
<html lang="en">
    ...
    <body>
        ...
        <section id ="empleados" class="description_content">
            ...
            <br>
            <br>
            <h1 class="titleForm">Modificar teléfono</h1>
            <br>
            <br>
            <br>
            <br>
            <br>
            <br>
            <form action="update_empleados_telefono.php" method="POST">

                <input type="text" name="id" id="id" required="required" class="formulario" placeholder="ID del empleado a modificar" />
                <input type="text" name="telefono" id="telefono" required="required" class="formulario" placeholder="Nuevo teléfono" />
